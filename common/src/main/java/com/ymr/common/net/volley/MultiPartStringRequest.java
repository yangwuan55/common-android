...
public class MultiPartStringRequest extends Request<String> implements MultiPartRequest{
	...
	private Map<File,String> fileUploads = new HashMap<File,String>();
    ...
    public void addFileUpload(Map<File,String> fileMap) {
    	fileUploads.putAll(fileMap);
    }
    
    public void addStringUpload(Map<String,String> param) {
    	stringUploads.putAll(param);
    }
